...
function resetLab() {
    isPaused = false;
    generateNewArray(); // bumps currentGeneration first — signals any in-flight animation to stop
    isRunning = false;  // safe to clear only after the generation has been incremented
